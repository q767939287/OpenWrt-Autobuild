...
curl -sSL https://github.com/openwrt/openwrt/raw/6eda2e2/target/linux/generic/hack-5.10/652-netfilter-always_check_dst.patch -o target/linux/generic/hack-5.10/652-netfilter-always_check_dst.patch
